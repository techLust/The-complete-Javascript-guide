...
const totalDepositUsd = function (deposit) {
    ...
    labelSumOut.textContent = formatCurr(Math.abs(withdrawal), deposit.locale, deposit.currency);
    ...
    labelSumInterest.textContent = formatCurr(interests, deposit.locale, deposit.currency);
